...
int ICACHE_FLASH_ATTR cgiUploadFirmware(HttpdConnData *connData) {
	...
	// check overall size
	debug("Max img sz 0x%X, post len 0x%X\n", def->fwSize, connData->post->len);
